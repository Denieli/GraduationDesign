        ...
        <div align="center">
            <div class="content">
                <img src="images/telephone.jpg" alt="">
                    ...
                    <%--</div>--%>
                    <div align="center">
                        <input type="button"  value="注 册"  class="move"  style="width: 115px;text-align: center; font-size: 20px; padding:5px 15px;color: #FFFFFF; background:#3B8AFF; border-radius:3px; border:#00A3FF 1px solid;"  onclick="register()" id="submit">
                    </div>
