...
<div id="addUser" class="login_layer" style="top: 200px; position: absolute;left: 50%;width:400px; height: 450px; border-radius:10px;">
...
<script>
    ...
    function wait(){
        ...
        $.ajax({
            url: '/user/getTeacherStuClass?categoryId='+loginCategoryId+'&userId='+loginId+'&authority='+loginAuthority,
            type: 'GET',
            success: function (result) {
                $("#myId").find("tr").remove();
                if(result.data.length>0){
