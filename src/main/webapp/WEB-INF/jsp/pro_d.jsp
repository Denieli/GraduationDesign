            ...
            <div class="pro_dar">
                ...
                <div>
                    ...
                    <div class="ant-same-style"><b>预约设备数量：</b>&emsp;
                        <input type="number"  class="orderNum" onchange="rangeOfValue(this)">可预约设备：<span class="inventory"></span>
                    </div>
                ...
                <div>
                    <div class="r_order" style="width: 115px; float: left"><a class="green" onclick="appointment()"><span>立即预约</span></a>  <a class="gray" ><span >立即预定</span></a> </div> <span class="orderInfo"></span>
                </div>
            </div>
        </div>
    </div>
